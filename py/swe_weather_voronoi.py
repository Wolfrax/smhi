...
DATA_DIR = "data"
FN_AVG_TEMP = "avg_temp_voronoi.svg"
FN_AIR_PRES = "air_pressure_voronoi.svg"
FN_RAINFALL = "rainfall_voronoi.svg"
FN_WIND = "wind_voronoi.svg"
FN_WIND_STREAM = "wind_stream_voronoi.svg"
EPSG = 4326  # WGS 84
...
if __name__ == "__main__":
    ...
    html_file_name = os.path.join(METOBS_DIR, "weather_voronoi.html")
    with app.app_context():
        html_file = render_template('swe_weather_voronoi.html', head=yesterday, images=images)
